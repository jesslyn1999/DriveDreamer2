...
weight_path = 'pretrained_models/drivedreamer2_video_cond/pytorch_gligen_weights.bin' # PATH TO YOUR MODEL 
# set None to load the latest checkpoint in your project_dir

save_path = '16-drivedreamer2_release/output/v1.0-trainval/drivedreamer2_video_cond' # PATH FOR SAVING GENERATED VIDEO
